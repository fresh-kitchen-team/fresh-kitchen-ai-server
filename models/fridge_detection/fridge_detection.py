...
- 상위 분류명·포괄어(예: 채소, 신선채소, 과일, 고기, 음료, 음료수, 주스, 견과류, 식품, 즉석식품, 음식, 소스 등 구체적 품목명이 아닌 모든 카테고리성 단어)는 절대 쓰지 마. 반드시 "사과", "두부"처럼 구체적인 품목명만 써줘.
- 무엇인지 정확히 단정할 수 없으면 추측하지 말고 그 항목을 반드시 빼. 애매한 걸 넣는 것보다 빼는 게 낫다.
