...
**공개 데이터셋 → 직접 크롤링 전환**: 초기에는 공개 데이터셋을 썼으나 원하는 한국 식재료 클래스가 없거나 품질이 들쭉날쭉해 학습에 부적합했음. 결국 **DuckDuckGo 크롤링으로 직접 수집 + 수작업 선별**해 약 **15,000장**(ver5 기준 train 12,714 / val 3,147)의 자체 데이터셋을 구축.
